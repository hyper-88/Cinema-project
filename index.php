...
<body>
    <!-- Создание идентификатора при визите -->
    <?php session_start();
    ...
    <div class="block-03">
        ...
        <div class="block-03__container">
            <table id="films_hire" class="block-03__table">
                <thead>
                    <tr>
                        <th class="block-03__table_colsize-1"><a href="#">Начало <span class="block-03__triangle-up"></span></a></th>
    ...
    <div id="block-07">
        <form method="POST" action="serv.php">
            <div id="block-07__present-window">
                ...
                <div>
                    <input type="hidden" name="id" value="<?php echo $id;?>" id="block-07__id">
